...
?>
  <div style="background-color: #4d64a6; background-image:url(/layout/images/bg-buy.jpg);background-size: cover;" class="page__block page__block--promo page__block--padding page__block--back">
    ...
    <div class="center xxl-margin-top xxl-padding-top">
      ...
      <div class="hidden-xs"><iframe frameborder="0" allowtransparency="true" scrolling="no" src="https://money.yandex.ru/embed/shop.xml?account=41001232198506&quickpay=shop&payment-type-choice=on&writer=seller&targets=<?=$srt?>&default-sum=500&button-text=02&mail=on&successURL=42.oldtimer.ru/buy/&comment=on&hint=%D0%92%D0%B2%D0%B5%D0%B4%D0%B8%D1%82%D0%B5+%D0%BF%D1%80%D0%BE%D0%BC%D0%BE+%D0%BA%D0%BE%D0%B4" width="450" height="268"></iframe></div>
